    ...
    public static void main(String[] args) {
        ...
        if (args.length >= 1) {
            try {
                ...
                System.err.println("I don't understand the parameter you passed me. What in the world is it? " +
        ...
        try {
            ...
            System.err.println("Something done went and blowed up: " + e.getMessage());

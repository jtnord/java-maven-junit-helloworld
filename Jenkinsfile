...
//          sh '"$MVN_HOME/bin/mvn" -Dspotbugs.failOnError=false install'
         sh '"$MVN_HOME/bin/mvn" --show-version --batch-mode --errors --no-transfer-progress -Dmaven.test.failure.ignore=true -Dspotbugs.failOnError=false  check install spotbugs:spotbugs'
